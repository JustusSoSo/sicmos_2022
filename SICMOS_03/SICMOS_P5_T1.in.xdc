...
#### containing some else impurities ####
    ...
    # SCH region's N well next to the P Well
    set N_SCH_1_x1=0
    set N_SCH_1_x2=$N_SCH_1_x1+$SCH_w
    # set N_SCH_1_x2=$N_SCH_1_x1+$sch_x2
    set N_SCH_2_x1=$CELL-$N_SCH_1_x2
    set N_SCH_2_x2=$CELL-$N_SCH_1_x1
    set tmp_conc_param_x=0.01
    set tmp_conc_param_y=0.05
    impurity id=35 reg.id=3 imp=Phosphorus \
        peak.value=$N_SCH ref.value=$N_SCH comb.func=Multiply \
        x1=$N_SCH_1_x1 \
        x2=$N_SCH_1_x2 \
    ...
    impurity id=36 reg.id=3 imp=Phosphorus \
        peak.value=$N_SCH ref.value=$N_SCH comb.func=Multiply \
        x1=$N_SCH_2_x1 \
        x2=$N_SCH_2_x2 \
        rolloff.x=both conc.func.x="Error Function" \
