...
# Breakdwon Voltage
    ...
    log outfile=./LOG/B_BV_SCH_w=$'SCH_width'.log
    # solve prev vdrain=0.001
    # solve prev vdrain=0.01
    # solve prev vdrain=0.1
    # solve prev vdrain=1
    solve prev vfinal=100 vstep=50 name=drain
    ...
    extract name="BV_SCH_w=$'SCH_width'" \
...
# extract name="BV_SCH_w=$'SCH_width'"
# $'SCH_width'
# extract init inf="./LOG/B_Ids-Vds_MOS_SCH_w=$'SCH_width'.log"
# $'SCH_width'
# SCH_w=$'SCH_width'
# log outfile=./LOG/B_Ids-Vds_BD_SCH_w=$'SCH_width'.log
# extract name="Von_SCH_w=$'SCH_width'" \
